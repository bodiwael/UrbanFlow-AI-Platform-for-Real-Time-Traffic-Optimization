/*
 * ESP32 Simple Traffic Controller with Firebase
 *
 * Controls:
 * - GPIO 2: Lane Light (controlled by /lane_light command)
 * - GPIO 4: Traffic Red Light
 * - GPIO 5: Traffic Yellow Light
 * - GPIO 18: Traffic Green Light
 * (GPIOs 4,5,18 controlled by /traffic_lights command)
 *
 * Firebase Commands (0=LOW, 1=HIGH):
 * - /lane_light: 0 or 1
 * - /traffic_lights: "000" to "111" (Red-Yellow-Green)
 */
...
#define WIFI_PASSWORD "park1234"

// ===== Firebase Configuration =====
#define FIREBASE_HOST "stem-53cdc-default-rtdb.firebaseio.com"
